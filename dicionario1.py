...
print(f"A categoria mais vendida do notebook foi: {vendas}")
print(f"A categoria mais vendida do ipad foi: {vendas}")
...
if vendas_tecnologia.get('lazer') == None:
    # Se a chave não estiver presente, exibe uma mensagem.
    print("O item não está no dicionário")
else:
    # Se a chave estiver presente, exibe outra mensagem.
    print("O item está no dicionário")

# Verifica se a chave 'copo' está no dicionário vendas_tecnologia usando o operador 'in'.
if 'copo' in vendas_tecnologia:
    # Se a chave estiver presente, exibe uma mensagem.
    print("O item está no dicionário")
else:
    # Se a chave não estiver presente, exibe outra mensagem.
    print("O item não está no dicionário")